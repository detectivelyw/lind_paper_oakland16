...
etc. Chou showed in~\cite{chou2001empirical} that function's directory, e.g., 
...
During this step, we conducted several other operations needed to access common paths, including intensive file management tasks to create/read/update or delete files and directories from the underlying (ext3) filesystem. These tests were completed during a discrete period of 20 hours over 5 days.
...
paths. \yanyan{I feel this is a bit early to make this conclusion.} \lois(does the slight wording change answer your concern, Yanyan?)
...
the kernel should definitely be reachable. \yanyan{how to define correct?} \lois(again, Yanyan, does the word change from "correct" to "as expected" help?)
