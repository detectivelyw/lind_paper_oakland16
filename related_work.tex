...
Attackers can easily find vulnerabilities to escape these systems and access arbitrary code in the underlying host systems. Lind addresses these concerns by using a much smaller and safer TCB.
